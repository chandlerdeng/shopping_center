...
define(function (require, exports, module) {
    ...
    (function(win){
        ...
        sign.prototype.getpluginPhoneCode=function(){
            var $val = $("#phone").val();
            $.post("http://m.csc86.com/password/getCode",{"phoneNumber":$val}, function(data) {
                console.log(data)
        ...
        sign.prototype.submitreg=function (){
            ...
            }else if(!ped)
            {
                ...
                $("#phonesbmit").prop("disabled", true).val("重置密码中...");
            }
            if(flag&&ped){
                $.post("http://m.csc86.com/password/retrieve",{
